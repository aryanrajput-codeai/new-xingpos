      ...
      <div className="relative h-[480px] w-full flex items-center justify-center">
        ...
        <div className="relative text-center px-6 max-w-4xl z-10">
          ...
          >
            ...
            <span className="text-[#d4af37] font-serif tracking-[0.25em] text-xs sm:text-sm uppercase font-semibold">{BRAND_CONFIG.established}</span>
          ...
          <div className="mt-4 flex items-center justify-center gap-4 text-xs font-mono text-gray-400">
            <span className="flex items-center gap-1.5"><Sparkles className="w-3 h-3 text-[#d4af37]" /> Authentic Flavours</span>
            <span className="text-[#d4af37]">•</span>
            <span className="flex items-center gap-1.5"><Flame className="w-3 h-3 text-[#d4af37]" /> Wok Fresh & Steamed Delicacies</span>
          </div>
