...
export default function MobileView({
  ...
  return (
    <div
      ...
      id="mobile-viewport"
    >
      {/* Pure Quality Top Pill banner / Status bar */}
      <div className="bg-stone-900 text-[10px] font-mono font-medium text-[#d4af37] border-b border-[#d4af37]/10 py-2.5 text-center tracking-wider uppercase flex items-center justify-center gap-1.5 px-4 sticky top-0 z-40">
        ...
        <span>{RESTAURANT_BRANDING.name}</span>
        <span>•</span>
        <span className="text-white font-sans">{RESTAURANT_BRANDING.tagline}</span>
      </div>
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 space-y-3">
                <span className="text-[10px] font-mono tracking-[0.25em] text-[#d4af37] uppercase font-bold">
                  {RESTAURANT_BRANDING.estd}
                </span>
                <h1 className="text-3xl font-serif font-extrabold text-white leading-tight tracking-wide uppercase">
                  {RESTAURANT_BRANDING.name}
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#d4af37] to-[#f3e5ab] text-xl font-medium mt-0.5 normal-case">
                    Authentic Dining & Cuisine
                  </span>
                </h1>
                <p className="text-xs text-gray-300 font-sans tracking-wide italic font-light opacity-90">
                  &ldquo;{RESTAURANT_BRANDING.tagline}&rdquo;
                </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-[10px] text-stone-500">
                  {RESTAURANT_BRANDING.contact.phone || "Configure in Settings"}
                </span>
              </div>
              ...
              >
                ...
                <span className="text-[10px] text-stone-500">
                  {RESTAURANT_BRANDING.contact.city || "City Center"}
                </span>
              </div>
            </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-stone-500 mt-1 font-light leading-relaxed">
                    {RESTAURANT_BRANDING.contact.address || "Restaurant Address (Configure in Settings)"}
                  </p>
                </div>
              </div>
            </div>
