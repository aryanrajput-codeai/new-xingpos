...
export default function AdminLogin({ onLoginSuccess }: AdminLoginProps) {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    // We authorize admin email: matches brand admin or demo admin credentials
    const isMasterEmail = email.toLowerCase() === "admin@thexingskitchen.com" || 
    ...
    if (isMasterEmail && isMasterPassword) {
      ...
      const payload = btoa(JSON.stringify({ sub: "restaurant_admin_id", role: "Owner", email: email }));
      ...
      setErrorCode(`Invalid cryptographic credentials. Please verify your admin email and passkey. Default developer admin: admin@thexingskitchen.com / admin123`);
      ...
      >
        ...
        <div className="text-center space-y-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-serif font-semibold text-stone-900 tracking-wide uppercase">
              {BRAND_CONFIG.restaurantName} <span className="text-[#aa7c11]">Control</span>
            </h1>
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="admin@thexingskitchen.com"
        ...
        <div className="mt-8 border-t border-stone-100 pt-4 text-center">
          <p className="text-[10px] sm:text-xs font-mono text-stone-400">
            ...
            <br />
            <span className="text-[#aa7c11]">admin@thexingskitchen.com</span> / <span className="text-stone-600 font-bold">admin123</span>
          </p>
        </div>
      </motion.div>
