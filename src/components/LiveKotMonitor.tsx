...
`;
      ...
      await LocalDB.apiAddPrinterLog({
        kotId: kot.id,
        kotNumber: kot.id,
        restaurantId: "idli-junction-subhash-nagar",
              ...
              <div className="space-y-6 overflow-y-auto pr-1">
                ...
                <div className="grid grid-cols-2 gap-4 bg-white/70 border border-stone-250/20 p-4 rounded-2xl text-xs shadow-xs">
                  <div>
                    ...
                    <span className="font-bold text-stone-800">{RESTAURANT_BRANDING.name} Main</span>
                  </div>
                  <div>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-4 py-6 bg-stone-50 border border-stone-200 rounded-2xl flex justify-center">
                ...
                >
                  ...
                  {/* Brand header */}
                  <span className="font-black text-xs block text-stone-950 uppercase tracking-widest text-center">{RESTAURANT_BRANDING.name.toUpperCase()}</span>
                  <span className="text-[9px] text-stone-500 text-center block mb-2">{RESTAURANT_BRANDING.tagline.toUpperCase()}</span>
                  ...
                  <span className="text-[9px] text-stone-400 text-center block mt-1">Powered by Webrajya</span>
                </div>
              </div>
