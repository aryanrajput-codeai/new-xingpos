...
export default function BulkMenuImporter({ onClose, onImportSuccess }: BulkMenuImporterProps) {
    ...
    const list: ProcessedItem[] = jsonData.map((row, index) => {
      ...
      if (rawGstPercent !== undefined && rawGstPercent !== null) {
        ...
        if (!isNaN(gstVal) && gstVal >= 0) {
          gstPercent = 0; // GST removed per user request
        }
      }
  ...
  const downloadTemplate = () => {
    const headers = [
      ...
      "Veg/Non-Veg", "HSN Code", "Bestseller", "Chef Special", 
    ...
    const data = [
      {
        ...
        "Description": "Spicy and tangy dark soup with chopped vegetables and crispy fried noodles on top.",
        "Price": 49,
        "Veg/Non-Veg": "Veg",
        "HSN Code": "21069099",
        "Bestseller": "Yes",
        ...
        "Spiciness": 1,
        "Rating": 4.8,
        "Image URL": "https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&q=80&w=600",
        "Available": "Yes"
      },
      {
        "Item Code": "SR-DOS-02",
      ...
      },
      {
        ...
        "Description": "Chef's signature golden wafer-thin crispy crepe. Served with piping hot sambar.",
        "Price": 110,
        "Veg/Non-Veg": "Veg",
        "HSN Code": "21069099",
        "Bestseller": "No",
      ...
      },
      {
        ...
        "Item Name": "Crispy Corn Chilli Pepper",
        "Description": "Crispy sweet corn kernels tossed with crushed black pepper, capsicum, and spring onions.",
        "Price": 99,
        "Veg/Non-Veg": "Veg",
        "HSN Code": "21069099",
        "Bestseller": "Yes",
        ...
        "Spiciness": 1,
        "Rating": 4.8,
        "Image URL": "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&q=80&w=600",
        "Available": "Yes"
      },
      {
        "Item Code": "SR-IND-01",
