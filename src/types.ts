...
export type OrderSource = "POS" | "QR_MENU";
...
// -------------------------------------------------------------
// STAFF, RBAC, PERMISSIONS & SECURITY TYPES
// -------------------------------------------------------------
...
export interface PermissionDefinition {
  ...
  requiresManagerApprovalForCashier?: boolean;
}
...
export interface StaffMember {
  ...
  phone: string;
  role: StaffRole;
  pin: string; // 4-6 digit numeric passcode
...
export interface ManagerOverrideContext {
  actionType: 
    | "edit_price" 
    | "edit_discount" 
    | "delete_item" 
